...
def prepare_model_settings(label_count, sample_rate, clip_duration_ms,
  ...
  # mfcc
  # fingerprint_size = dct_coefficient_count * spectrogram_length # mfcc

  # spectrogram
  fingerprint_size = 25186 # spectrogram
  dct_coefficient_count = 257 # spectrogram length

  print ("spectrogram_length", dct_coefficient_count)
...
#
# print ("Reshape values:", input_frequency_size, input_time_size)
# print ("Complete reshape thing:", fingerprint_input, [-1, input_time_size, input_frequency_size, 1])
